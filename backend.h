...
class BackEnd : public QObject
{
    ...
    Q_PROPERTY(bool ZeroPosButtonEnabled READ ZeroPosButtonEnabled WRITE setZeroPosButtonEnabled NOTIFY ZeroPosButtonEnabledChanged)
    Q_PROPERTY(bool CancelRouteButtonEnabled READ CancelRouteButtonEnabled WRITE setCancelRouteButtonEnabled NOTIFY CancelRouteButtonEnabledChanged)
...
public:
    ...
    bool ZeroPosButtonEnabled() const { return m_ZeroPosButtonEnabled; }
    bool CancelRouteButtonEnabled() const { return m_CancelRouteButtonEnabled; }
...
public slots:
    ...
    void setZeroPosButtonEnabled(bool ZeroPosButtonEnabled)
    {
        if (m_ZeroPosButtonEnabled == ZeroPosButtonEnabled)
            return;

        m_ZeroPosButtonEnabled = ZeroPosButtonEnabled;
        emit ZeroPosButtonEnabledChanged(m_ZeroPosButtonEnabled);
    }

    void setCancelRouteButtonEnabled(bool CancelRouteButtonEnabled)
    {
        if (m_CancelRouteButtonEnabled == CancelRouteButtonEnabled)
            return;

        m_CancelRouteButtonEnabled = CancelRouteButtonEnabled;
        emit CancelRouteButtonEnabledChanged(m_CancelRouteButtonEnabled);
    }
...
signals:
    ...
    void ZeroPosButtonEnabledChanged(bool ZeroPosButtonEnabled);
    void CancelRouteButtonEnabledChanged(bool CancelRouteButtonEnabled);
...
private:
    ...
    bool m_ZeroPosButtonEnabled;
    bool m_CancelRouteButtonEnabled;
