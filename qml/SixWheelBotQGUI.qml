...
Rectangle {
    ...
    Item {
        ...
        Image {
            ...
            Item {
                property int info_opacity: backend.DrivingInfoOpacity
                id: drivingInfo
                x: 18
                y: 59
                width: 200
                height: 200
                opacity: info_opacity / 100

                Label {
                    id: targetDistanceTxt
                    x: 210
                    y: 309
                    width: 152
                    height: 18
                    color: "#4df6ff"
                    text: qsTr("TARGET DISTANCE:")
                    ...
                    Label {
                        id: targetDistanceVal
                        x: 172
                        y: 0
                        width: 178
                        height: 18
                        color: "#4df6ff"
                        text: backend.TargetDistanceVal
                        horizontalAlignment: Text.AlignLeft
                        verticalAlignment: Text.AlignVCenter
                        font.bold: true
                        font.pointSize: 11
                ...
                Label {
                    id: relativeBearingTxt
                    x: 0
                    y: 330
                    width: 152
                    height: 18
                    color: "#4df6ff"
                    text: qsTr("RELATIVE BEARING:")
                    horizontalAlignment: Text.AlignLeft
                    verticalAlignment: Text.AlignTop
                    font.bold: true
                    font.pointSize: 11
                    ...
                    Label {
                        id: relativeBearingVal
                        x: 168
                        y: 0
                        width: 87
                        height: 18
                        color: "#4df6ff"
                        text: backend.RelativeBearingVal
                        verticalAlignment: Text.AlignVCenter
                        font.pointSize: 11
                    }
                }
